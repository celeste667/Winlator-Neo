...
public class PresentExtension extends Extension {
    ...
    // Intervalo em microsegundos por frame. Default = 60fps.
    // Altere via setTargetFps() para limitar o FPS do jogo na fonte.
    private int fakeInterval = 1000000 / 60;

    public void setTargetFps(int fps) {
        fakeInterval = 1000000 / Math.max(1, fps);
    }

    public int getTargetFps() {
        return 1000000 / fakeInterval;
    }
