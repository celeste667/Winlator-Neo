...
public class Container {
    ...
    /** Caminho fixo para os componentes instaláveis do Winlator (Drive K:). */
    public static final String INSTALLED_COMPONENTS_PATH = "/data/data/com.winlator/files/installed_components";
